...
t.InitCommand=cmd(SetUpdateFunction,Update);
        ...
        if GAMESTATE:IsHumanPlayer(PLAYER_1) then
        	self:GetChild("Player1Life"):GetChild("Player1LifeBG"):faderight(0.5+((1-PLife(PLAYER_1))*0.5))
        	self:GetChild("Player1Life"):GetChild("Player1LifeBG"):zoomx(70+(PLife(PLAYER_1)*200))
			self:GetChild("Player1Life"):GetChild("Player1LifeVal"):target_number(PLife(PLAYER_1)*100);
			...
			elseif PLife(PLAYER_1)*100 <= 0 then
                ...
                self:GetChild("Player1Life"):visible(false)
        end;
 
        if GAMESTATE:IsHumanPlayer(PLAYER_2) then
        	self:GetChild("Player2Life"):GetChild("Player2LifeBG"):fadeleft(0.5+((1-PLife(PLAYER_2))*0.5))
        	self:GetChild("Player2Life"):GetChild("Player2LifeBG"):zoomx(70+(PLife(PLAYER_2)*200))
            self:GetChild("Player2Life"):GetChild("Player2LifeVal"):target_number(PLife(PLAYER_2)*100);
			...
			elseif PLife(PLAYER_2)*100 <= 0 then
                ...
                self:GetChild("Player2Life"):visible(false)
        end;
end;
