...
t[#t+1] = LoadFont("Common Large") .. {
	InitCommand=cmd(xy,SCREEN_CENTER_X,SCREEN_CENTER_Y-50;zoom,0.5;settext,GAMESTATE:GetCurrentSong():GetDisplayMainTitle();diffusealpha,0;maxwidth,400/0.45);
...
t[#t+1] = LoadFont("Common Normal") .. {
	InitCommand=cmd(xy,SCREEN_CENTER_X,SCREEN_CENTER_Y-35;zoom,0.45;settext,GAMESTATE:GetCurrentSong():GetDisplaySubTitle();diffusealpha,0;maxwidth,400/0.45);
...
t[#t+1] = LoadFont("Common Normal") .. {
	InitCommand=cmd(xy,SCREEN_CENTER_X,SCREEN_CENTER_Y-25;zoom,0.45;settext,GAMESTATE:GetCurrentSong():GetDisplayArtist();diffusealpha,0);
